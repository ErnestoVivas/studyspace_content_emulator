...
class MultipleChoiceQuestion extends Model {
  ...
  final String? _multiplechoicequestionsetID;
  ...
  String? get multiplechoicequestionsetID {
    return _multiplechoicequestionsetID;
  }
  ...
  const MultipleChoiceQuestion._internal({required this.id, key, title, image, equation, description, question, numberOfAnswers, correctAnswer, answer0, answer1, answer2, answer3, answer4, multiplechoicequestionsetID, createdAt, updatedAt}): _key = key, _title = title, _image = image, _equation = equation, _description = description, _question = question, _numberOfAnswers = numberOfAnswers, _correctAnswer = correctAnswer, _answer0 = answer0, _answer1 = answer1, _answer2 = answer2, _answer3 = answer3, _answer4 = answer4, _multiplechoicequestionsetID = multiplechoicequestionsetID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory MultipleChoiceQuestion({String? id, String? key, String? title, String? image, String? equation, String? description, String? question, int? numberOfAnswers, int? correctAnswer, String? answer0, String? answer1, String? answer2, String? answer3, String? answer4, String? multiplechoicequestionsetID}) {
    return MultipleChoiceQuestion._internal(
      ...
      answer3: answer3,
      answer4: answer4,
      multiplechoicequestionsetID: multiplechoicequestionsetID);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is MultipleChoiceQuestion &&
      ...
      _multiplechoicequestionsetID == other._multiplechoicequestionsetID;
  }
  ...
  String toString() {
    ...
    buffer.write("multiplechoicequestionsetID=" + "$_multiplechoicequestionsetID" + ", ");
  ...
  MultipleChoiceQuestion copyWith({String? id, String? key, String? title, String? image, String? equation, String? description, String? question, int? numberOfAnswers, int? correctAnswer, String? answer0, String? answer1, String? answer2, String? answer3, String? answer4, String? multiplechoicequestionsetID}) {
    return MultipleChoiceQuestion._internal(
      id: id ?? this.id,
      key: key ?? this.key,
      ...
      multiplechoicequestionsetID: multiplechoicequestionsetID ?? this.multiplechoicequestionsetID);
  }
  ...
  MultipleChoiceQuestion.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _multiplechoicequestionsetID = json['multiplechoicequestionsetID'],
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'key': _key, 'title': _title, 'image': _image, 'equation': _equation, 'description': _description, 'question': _question, 'numberOfAnswers': _numberOfAnswers, 'correctAnswer': _correctAnswer, 'answer0': _answer0, 'answer1': _answer1, 'answer2': _answer2, 'answer3': _answer3, 'answer4': _answer4, 'multiplechoicequestionsetID': _multiplechoicequestionsetID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final QueryField MULTIPLECHOICEQUESTIONSETID = QueryField(fieldName: "multiplechoicequestionsetID");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["multiplechoicequestionsetID"], name: "byMultipleChoiceQuestionSet")
    ];
    
    modelSchemaDefinition.addField(ModelFieldDefinition.id());
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.KEY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.TITLE,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.DESCRIPTION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.NUMBEROFANSWERS,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.CORRECTANSWER,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.ANSWER0,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.ANSWER1,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.ANSWER2,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.ANSWER3,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.ANSWER4,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MultipleChoiceQuestion.MULTIPLECHOICEQUESTIONSETID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
