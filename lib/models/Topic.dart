...
class Topic extends Model {
  ...
  const Topic._internal({required this.id, required subject, required key, required index, required isGroupLabel, required name, required categories, createdAt, updatedAt}): _subject = subject, _key = key, _index = index, _isGroupLabel = isGroupLabel, _name = name, _categories = categories, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Topic({String? id, required int subject, required int key, required int index, required bool isGroupLabel, required String name, required TopicCategories categories}) {
  ...
  Topic copyWith({String? id, int? subject, int? key, int? index, bool? isGroupLabel, String? name, TopicCategories? categories}) {
    return Topic._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'subject': _subject, 'key': _key, 'index': _index, 'isGroupLabel': _isGroupLabel, 'name': _name, 'categories': _categories?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'subject': _subject, 'key': _key, 'index': _index, 'isGroupLabel': _isGroupLabel, 'name': _name, 'categories': _categories, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
